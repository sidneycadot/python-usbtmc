...
The functionality of this package is implemented in the UsbTmcInterface class, which we import here so it will be
available for import directly from the usbtmc package.
"""
